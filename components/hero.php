<?php
  $hero_data = json_decode(json_encode([
    ...
    'background' => 'https://images.unsplash.com/photo-1593938637267-7d70420742a3?q=80&w=2938&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    'navigations' => [
      ['title' => 'Kebijakan', 'link' => './pages/kebijakan.php', 'active' => false],
      ['title' => 'Standar Operasional dan Prosedur', 'link' => './pages/standar_operasional_dan_prosedur.php', 'active' => false],
...
<main id="hero-root" style="background-image: url(<?= $hero_data->background; ?>)">
    ...
    <div class="hero-right">
      <div class="navigation-list">
        <?php foreach ($hero_data->navigations as $navigation) : ?>
          <a href="<?= $navigation->link; ?>" class="navigation-item">
            <?= $navigation->title; ?>
          </a>
        <?php endforeach; ?>
      </div>
...
<script defer>
  document.addEventListener('DOMContentLoaded', () => {
    const heroHamburgerBtn = document.querySelector('#hero-root .hamburger-btn')
    const heroHamburgerBtnClose = document.querySelector('#hamburger-content .hamburger-btn-close')
    const heroHamburgerContent = document.querySelector('#hamburger-content')
