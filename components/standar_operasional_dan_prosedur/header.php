<?php
  $hero_data = json_decode(json_encode([
    ...
    'navigations' => [
      ...
      ['title' => 'Standar Operasional dan Prosedur', 'link' => './standar_operasional_dan_prosedur.php', 'active' => true],
...
<main id="sop-header-root" style="background-image: url(<?= $hero_data->background; ?>)">
...
<script defer>
  document.addEventListener('DOMContentLoaded', () => {
    const heroHamburgerBtn = document.querySelector('#sop-header-root .hamburger-btn')
    const heroHamburgerBtnClose = document.querySelector('#sop-hamburger-content .hamburger-btn-close')
    const heroHamburgerContent = document.querySelector('#sop-hamburger-content')
