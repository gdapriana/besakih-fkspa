<?php
  $hero_data = json_decode(json_encode([
    ...
    'navigations' => [
      ...
      ['title' => 'Struktur Organisasi', 'link' => './struktur_organisasi.php', 'active' => true],
...
<main id="struktur-header-root" style="background-image: url(<?= $hero_data->background; ?>)">
...
<div id="struktur-hamburger-content">
...
<script defer>
  document.addEventListener('DOMContentLoaded', () => {
    const heroHamburgerBtn = document.querySelector('#struktur-header-root .hamburger-btn')
    const heroHamburgerBtnClose = document.querySelector('#struktur-hamburger-content .hamburger-btn-close')
    const heroHamburgerContent = document.querySelector('#struktur-hamburger-content')
