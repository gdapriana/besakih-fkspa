<?php
  $hero_data = json_decode(json_encode([
    ...
    'navigations' => [
      ['title' => 'Kebijakan', 'link' => './kebijakan.php', 'active' => true],
...
<main id="kebijakan-header-root" style="background-image: url(<?= $hero_data->background; ?>)">
...
<div id="kebijakan-hamburger-content">
...
<script defer>
  document.addEventListener('DOMContentLoaded', () => {
    const heroHamburgerBtn = document.querySelector('#kebijakan-header-root .hamburger-btn')
    const heroHamburgerBtnClose = document.querySelector('#kebijakan-hamburger-content .hamburger-btn-close')
    const heroHamburgerContent = document.querySelector('#kebijakan-hamburger-content')
